...
<style>
   body {
    ...
    background-image: linear-gradient(to bottom, #262626 545px,  #000000 100px);
    color: #000000;
    padding: 20px;
}
.btn {
...
@media screen and (max-width: 600px) {
    .card {
        width: calc(40% - 20px); /* On smaller screens, make each card occupy full width */
    }
}
...
.nav-links li a:hover {
    color: white; /* Change link text color to yellow on hover */
    box-shadow: 0px 0px 40px rgba(255, 255, 255, 0.5); /* Box-shadow on hover */
}
...
.slideshow-container {
    ...
    margin: auto;
    overflow: hidden;
    box-shadow: 0px 0px 40px rgba(255, 255, 255, 0.5); /* Changed RGBA values to make the shadow white */
}
...
.navigation button:hover {
    box-shadow: 0px 0px 40px rgba(255, 255, 255, 0.5); /* Shadow effect on hover */
    color: white; /* Change button text color to orange on hover */
}
